<template>
  <div class="flex h-screen text-white items-center justify-center bg-gray-900">
    <img src="../assets/reading.avif" alt="reading" class="rounded-xl w-[400px] h-[600px] ml-40" />

    <div class="flex items-center justify-center w-1/2">
      <div class="w-1/2 max-w-md p-6 rounded-lg bg-gray-600">
        ...
        <form @submit.prevent="handleSignup" class="space-y-4">
          ...
          <input
            ...
            required
            class="w-full mt-1 p-2 border border-gray-700 rounded-lg"
          />
